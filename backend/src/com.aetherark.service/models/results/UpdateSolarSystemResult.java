...
public class UpdateSolarSystemResult {
    private SolarSystemModel solarSystemModel;

    public UpdateSolarSystemResult(Builder builder) {
    ...
    public static final class Builder {
        ...
        public UpdateSolarSystemResult build() {
            return new UpdateSolarSystemResult(this);
        }
